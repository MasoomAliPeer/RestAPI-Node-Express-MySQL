...
export const checkEmailExists = `SELECT * FROM user WHERE EmailAddress = ?`;

export const updateTOKEN_OTP = `UPDATE user SET ResetToken = ?, OTP = ? WHERE EmailAddress = ?`;

export const verifyOTP = `SELECT * FROM user WHERE EmailAddress = ? AND OTP = ?`;

export const resetPassword = `UPDATE user SET password = ? WHERE EmailAddress = ?`;
